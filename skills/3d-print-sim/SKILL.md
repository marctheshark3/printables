...
metadata:
  hermes:
    tags: [3d-print, assembly, sim, joints, occupancy, loads, clearance, robot-module, kit, rover, validate, table-flat, mjcf]
...
**Don’t:** treat a render as proof; parse MJCF/URDF/USD/Markdown as the contract; add ROS, Isaac, or Gazebo as a hard dependency; relax mesh HARD gates so occupancy can pass.
