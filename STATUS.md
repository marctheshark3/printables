...
- `3d-print-photo-cad` reads XY millimetres from a printed 15.0 mm ChArUco photo after a ruler check. Metric only on the board plane. Official drawing wins. Not a caliper. Installed by `./install.sh`. Not in `/3d-print`.
