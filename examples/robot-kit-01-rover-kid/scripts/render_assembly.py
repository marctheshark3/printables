#!/usr/bin/env python3
"""Preview-only assembly stills from PRINT_SPEC poses. Not a manufacturing body."""
...
def main() -> int:
    ...
    shots = {
        "assembly.png": ((-20.0, -115.0, 140.0), (54.0, 31.0, 32.0)),
        "assembly-front.png": ((170.0, -95.0, 110.0), (70.0, 31.0, 36.0)),
        "assembly-face.png": ((175.0, 31.0, 62.0), (100.0, 31.0, 58.0)),
    }
